...
class FontManager:
    ...
    def _lookup_win(self, key, basename, styles, fail=False):
        for suffix in ('', ' (TrueType)'):
            ...
            if fail:
                raise FontNotFound(f'Font {basename} ({styles[0]}) not found in homepage')
            return None
    ...
    def _create_win(self):
        ...
        for keyname in keynames:
            ...
            # If we get here, we checked all homepage keys and had no luck
            ...
            if lookuperror:
                raise lookuperror
            raise FontNotFound('Can\'t open Windows font homepage key')
